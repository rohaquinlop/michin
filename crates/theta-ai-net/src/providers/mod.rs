...
//!
//! ProviderRegistry lives in theta-ai. This module provides the
...
pub fn default_registry() -> theta_ai::providers::ProviderRegistry {
    let mut registry = theta_ai::providers::ProviderRegistry::new();
    ...
    registry.register(theta_ai::types::Api::OpenAiCompletions, Box::new(compat));
    registry.register(
        theta_ai::types::Api::OpenAiCodexResponses,
